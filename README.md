...
For running FlowRL using the verl framework, check out the official recipe:

👉 **verl Recipe:** [https://github.com/volcengine/verl/pull/3924](https://github.com/volcengine/verl/pull/3924)
